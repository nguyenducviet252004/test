        ...
        try {
            ...
            $products = $products->map(function ($product) {
                return [
                    ...
                    'price' => $product->min_price, // Sử dụng min_price từ accessor
                    'view' => $product->view,
        ...
        try {
            ...
            $product->galleries = $product->galleries->map(function ($gallery) {
                return [
                    ...
                    'image_url' => $gallery->image_path ? asset('storage/' . $gallery->image_path) : null,
            ...
            $response = [
                ...
                'name' => $product->name,
                'description' => $product->description,
                'avatar_url' => $product->img_thumb ? asset('storage/' . $product->img_thumb) : null, // Cập nhật đường dẫn avatar ở đây
                'categories' => $product->categories,
                'price' => $product->min_price, // Sử dụng min_price từ accessor
                'view' => $product->view,
                ...
                'created_at' => $product->created_at,
                'updated_at' => $product->updated_at,
                'variants' => $product->variants, // Add variants here
            ];
