...
<body class="container mt-5">
        ...
        <div class="menu-container bg-light p-3">
            <a href="<?php echo e(route('user.edit')); ?>">
                <div class="nav-profile-text d-flex align-items-center">
                    ...
                    <img src="<?php echo e(asset('storage/' . Auth::user()->avatar)); ?>" width="50px" alt="profile"
                    ...
                    <div class="ms-2">
                        ...
                        <span
                            style="color: purple"><?php echo e(Auth::user()->fullname ?? (Auth::user()->email ?? Auth::user()->username)); ?></span>
                    </div>
            ...
            <ul class="menu list-unstyled">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-content list-unstyled ps-3" style="display: block;"> <!-- Đặt display: block -->
                        <li><a href="<?php echo e(route('user.edit')); ?>">Hồ Sơ</a></li>
                        <li><a href="<?php echo e(route('address.index')); ?>">Địa Chỉ</a></li>
                        <li><a href="<?php echo e(route('user.changepass.form')); ?>">Đổi Mật Khẩu</a></li>
                    </ul>
                </li>
                <li class="zalo-icon">
                ...
                <li><a href="<?php echo e(route('userorder.index')); ?>" class="btn btn-light w-100 text-start">Đơn Mua</a></li>
                <li><a href="<?php echo e(route('uservouchers.index')); ?>" class="btn btn-light w-100 text-start">Kho Voucher</a>
                </li>
                <li>
    ...
    <script src="<?php echo e(asset('user/script.js')); ?>"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"></script>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\datn-wd110-46\backend\resources\views/user/master.blade.php ENDPATH**/ ?>