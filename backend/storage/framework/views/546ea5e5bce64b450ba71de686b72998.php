...
<body>
    ...
    <div class="container">
        ...
        <p>Chào bạn,</p>
        <p>Chúng tôi xin thông báo rằng đơn hàng với mã đơn hàng: <span class="order-id">#<?php echo e($order->id); ?></span> của bạn đã được giao thành công.</p>
...
<?php /**PATH C:\xampp\htdocs\datn-wd110-47\backend\resources\views/email/order_delivered.blade.php ENDPATH**/ ?>