...
<body>
    ...
    <div class="container">
        ...
        <p>Chào bạn,</p>
        <p>Chúng tôi xin thông báo rằng đơn hàng của bạn với mã đơn hàng: <span class="order-id">#<?php echo e($order->id); ?></span> đã được duyệt và chuyển sang trạng thái <strong>"Đã duyệt"</strong>.</p>
...
<?php /**PATH C:\xampp\htdocs\datn-wd110-47\backend\resources\views/email/order_status_changed.blade.php ENDPATH**/ ?>