...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        // Force cache refresh
        console.log('🔍 Debug: User ID from meta:', '<?php echo e($orders->first()->user_id ?? auth()->id()); ?>');
        console.log('🔍 Debug: Auth ID:', '<?php echo e(auth()->id()); ?>');
        console.log('🔍 Debug: First order user ID:', '<?php echo e($orders->first()->user_id ?? "no orders"); ?>');
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder (2)\backend\resources\views/user/order.blade.php ENDPATH**/ ?>