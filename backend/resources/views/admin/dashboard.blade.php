...
@section('content_admin')
    ...
    <div class="dashboard-stats mt-4">
        <div class="stat-item">
            ...
            <p class="stat-value">{{ number_format($totalRevenue, 0, ',', '.') }} VND</p>
        ...
        <div class="stat-item">
            ...
            <p class="stat-value">{{ $totalUsers }} Thành viên</p>
            <small class="text-muted">Tất cả thời gian</small>
        </div>
        <div class="stat-item">
            <h2>Đã Hoàn Thành</h2>
            <p class="stat-value">{{ $completedOrders }} Đơn hàng</p>
            @if(isset($ordersChange))
                <div class="stat-change {{ $ordersChange >= 0 ? 'positive' : 'negative' }}">
                    <i class="mdi mdi-{{ $ordersChange >= 0 ? 'trending-up' : 'trending-down' }}"></i>
        ...
        <div class="stat-item">
            <h2>Chưa Xử Lí </h2>
            <p class="stat-value">{{ $pendingOrders }} Đơn hàng</p>
